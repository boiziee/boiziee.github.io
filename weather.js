$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "The current weather is " + data.currently.summary + " and the current temperature is " + data.currently.apparentTemperature + "°F." + 
    ...
    "- Day 1 : " + data.daily.data[1].summary + "<br>" + 
    "- Day 2 : " + data.daily.data[2].summary + "<br>" + 
    "- Day 3 : " + data.daily.data[3].summary + "<br>" + "<br>" + 
